...
const
    ...
    COOP_AI_SAVE_PARTNER_DELAY_MS = 5000
;
...
const captureSound = 'CaptureSound', shipCapturedSound = 'ShipCapturedSound', dualShipSound = 'DualShipSound',
      playerShootSound = 'PlayerShootSound', explosionSound = 'ExplosionSound', gameOverSound = 'GameOverSound',
      lostLifeSound = 'LostLifeSound', entranceSound = 'EntranceSound', bossGalagaDiveSound = 'BossGalagaDiveSound',
      levelUpSound = 'LevelUpSound', enemyShootSound = 'EnemyShootSound', butterflyDiveSound = 'ButterflyDiveSound',
      startSound = 'StartSound', coinSound = 'CoinSound', beeHitSound = 'BeeHitSound',
      butterflyHitSound = 'ButterflyHitSound', bossHit1Sound = 'BossHit1Sound', bossHit2Sound = 'BossHit2Sound',
      gridBackgroundSound = 'GridBackgroundSound', extraLifeSound = 'ExtraLifeSound', csPerfectSound = 'CSPerfectSound',
      csClearSound = 'CSClearSound', waveUpSound = 'WaveUpSound', menuMusicSound = 'MenuMusicSound',
      readySound = 'ReadySound', resultsMusicSound = 'ResultsMusicSound', hiScoreSound = 'HiScoreSound',
      tripleAttackSound = 'TripleAttackSound';

// --- Constants (verplaatst van deel 2) ---
const BASE_ENEMY_BULLET_SPEED = 9, MAX_ENEMY_BULLET_SPEED = 9, BASE_ENEMY_ATTACK_SPEED = 5.5, MAX_ENEMY_ATTACK_SPEED = 8.0, BASE_MAX_ATTACKING_ENEMIES = 10, MAX_MAX_ATTACKING_ENEMIES = 22, BASE_GRID_MOVE_SPEED = 0.3, MAX_GRID_MOVE_SPEED = 0.7, BASE_GRID_BREATH_CYCLE_MS = 2000, MIN_GRID_BREATH_CYCLE_MS = 1000, BASE_ENEMY_BULLET_BURST_COUNT = 1, MAX_ENEMY_BULLET_BURST_COUNT = 5, BASE_ENEMY_AIM_FACTOR = 0.75, MAX_ENEMY_AIM_FACTOR = 0.95, BASE_BEE_GROUP_ATTACK_PROBABILITY = 0.05, MAX_BEE_GROUP_ATTACK_PROBABILITY = 0.40, BASE_BEE_TRIPLE_ATTACK_PROBABILITY = 0.10, MAX_BEE_TRIPLE_ATTACK_PROBABILITY = 0.50,
      PLAYER_BULLET_WIDTH = 5, PLAYER_BULLET_HEIGHT = 15, PLAYER_BULLET_SPEED = 14, DUAL_SHIP_BULLET_OFFSET_X = SHIP_WIDTH * 0.5, ENEMY_BULLET_WIDTH = 4, ENEMY_BULLET_HEIGHT = 12, NUM_STARS = 500, MAX_STAR_RADIUS = 1.5, MIN_STAR_RADIUS = 0.5, TWINKLE_SPEED = 0.015, BASE_PARALLAX_SPEED = 0.3, PARALLAX_SPEED_FACTOR = 2.0, STAR_FADE_START_FACTOR_ABOVE_HORIZON = 0.25, GRID_RGB_PART = "100, 180, 255", GRID_BASE_ALPHA = 0.8, GRID_MIN_ALPHA = 0.3, GRID_FIXED_LINES_ALPHA = 0.5, GRID_LINE_COLOR_FIXED = `rgba(${GRID_RGB_PART}, ${GRID_FIXED_LINES_ALPHA})`, GRID_LINE_WIDTH = 2, GRID_SPEED = 0.4, GRID_HORIZON_Y_FACTOR = 0.74, GRID_BASE_SPACING = 15, GRID_SPACING_POWER = 2.0, GRID_HORIZONTAL_LINE_WIDTH_FACTOR = 1.5, GRID_NUM_PERSPECTIVE_LINES = 14, GRID_HORIZON_SPREAD_FACTOR = 1.2, GRID_BOTTOM_SPREAD_FACTOR = 2.0, GRID_PERSPECTIVE_POWER = 1.0, MENU_INACTIVITY_TIMEOUT = 20000, SCORE_SCREEN_DURATION = 20000, ENTRANCE_SPEED = 6, BASE_RETURN_SPEED = ENTRANCE_SPEED, NORMAL_ENTRANCE_PATH_SPEED = 0.013934592, BOSS_LOOP_ENTRANCE_PATH_SPEED = 0.055738368, ENEMY_SPAWN_DELAY_IN_SQUADRON = 100, ENTRANCE_PAIR_HORIZONTAL_GAP = 5, ENTRANCE_PAIR_PATH_T_OFFSET = 0.00, NORMAL_WAVE_SQUADRON_INTERVAL = 1800, ENTRANCE_FIRE_BURST_DELAY_MS = 80, CS_ENTRANCE_PATH_SPEED = 0.0032, CS_COMPLETION_MESSAGE_DELAY = 1000, ENEMY_ANIMATION_INTERVAL_MS = 250, AXIS_DEAD_ZONE_MENU = 0.3, AXIS_DEAD_ZONE_GAMEPLAY = 0.15, PS5_BUTTON_CROSS = 0, PS5_BUTTON_CIRCLE = 1, PS5_BUTTON_TRIANGLE = 3, PS5_BUTTON_R1 = 5, PS5_DPAD_UP = 12, PS5_DPAD_DOWN = 13, PS5_DPAD_LEFT = 14, PS5_DPAD_RIGHT = 15, PS5_LEFT_STICK_X = 0, PS5_LEFT_STICK_Y = 1, SHOOT_COOLDOWN = 140, CS_MULTI_BULLET_COUNT = 2, CS_MULTI_BULLET_SPREAD_ANGLE_DEG = 8, GRID_ROWS = 5, GRID_COLS = 10, ENEMY_V_SPACING = 20, ENEMY_H_SPACING_FIXED = 30, ENEMY_TOP_MARGIN = 117, GRID_HORIZONTAL_MARGIN_PERCENT = 0.18, GRID_BREATH_ENABLED = true, GRID_BREATH_MAX_EXTRA_H_SPACING_FACTOR = 0.5, GRID_BREATH_MAX_EXTRA_V_SPACING_FACTOR = 0.3, ENEMY1_DIVE_SPEED_FACTOR = 0.65, ENEMY2_DIVE_SPEED_FACTOR = 0.75, ENEMY3_ATTACK_SPEED_FACTOR = 0.80, BOSS_CAPTURE_DIVE_SPEED_FACTOR = 0.85, GROUP_DETACH_DELAY_MS = 80, GROUP_FIRE_BURST_DELAY = 600, SOLO_BUTTERFLY_FIRE_DELAY = 600, BOSS_CAPTURE_DIVE_PROBABILITY = 0.15, CAPTURE_DIVE_SIDE_MARGIN_FACTOR = 0.15, CAPTURE_DIVE_BOTTOM_HOVER_Y_FACTOR = 0.70, CAPTURE_BEAM_DURATION_MS = 5000, CAPTURE_BEAM_ANIMATION_DURATION_MS = 500, CAPTURE_BEAM_WIDTH_TOP_FACTOR = 0.7, CAPTURE_BEAM_WIDTH_BOTTOM_FACTOR = 1.8, CAPTURE_BEAM_COLOR_START = 'rgba(180, 180, 255, 0.1)', CAPTURE_BEAM_COLOR_END = 'rgba(220, 220, 255, 0.6)', CAPTURE_BEAM_PULSE_SPEED = 0.004, CAPTURED_SHIP_SCALE = 1.0, CAPTURED_SHIP_OFFSET_X = (BOSS_WIDTH - SHIP_WIDTH) / 2, CAPTURED_SHIP_OFFSET_Y = -SHIP_HEIGHT * 0.5, CAPTURE_MESSAGE_DURATION = 3000, CAPTURED_SHIP_TINT_COLOR = 'rgba(255, 150, 150, 0.55)', CAPTURED_SHIP_FIRE_COOLDOWN_MS = 500, RESPAWN_DELAY_MS = 2000, INVINCIBILITY_DURATION_MS = 2000, INVINCIBILITY_BLINK_ON_MS = 100, INVINCIBILITY_BLINK_OFF_MS = 50, FALLING_SHIP_SPEED = 3.5, FALLING_SHIP_FADE_DURATION_MS = 1500, FALLING_SHIP_ROTATION_DURATION_MS = 1500, FALLING_SHIP_ROTATION_SPEED = 0.1, DUAL_SHIP_DOCK_TIME_MS = 1000, DUAL_SHIP_OFFSET_X = SHIP_WIDTH, AUTO_DOCK_THRESHOLD = 20, FLOATING_SCORE_DURATION = 500, FLOATING_SCORE_APPEAR_DELAY = -50, FLOATING_SCORE_FONT = "bold 12px 'Press Start 2P'", FLOATING_SCORE_OPACITY = 0.5, FLOATING_SCORE_COLOR_GRID = "cyan", FLOATING_SCORE_COLOR_ACTIVE = "red", FLOATING_SCORE_COLOR_CS_CHAIN = "cyan", CS_CHAIN_SCORE_THRESHOLD = 4, CS_CHAIN_BREAK_TIME_MS = 500, NORMAL_WAVE_CHAIN_BONUS_ENABLED = false, NORMAL_WAVE_CHAIN_SCORE_THRESHOLD = 4, NORMAL_WAVE_CHAIN_BREAK_TIME_MS = 750, EXPLOSION_DURATION = 650, EXPLOSION_PARTICLE_COUNT = 25, EXPLOSION_MAX_SPEED = 5.5, EXPLOSION_MIN_SPEED = 1.5, EXPLOSION_PARTICLE_RADIUS = 4, EXPLOSION_FADE_SPEED = 2.8, EXPLOSION_MAX_OPACITY = 0.8, HIT_SPARK_COUNT = 8, HIT_SPARK_LIFETIME = 1500, HIT_SPARK_SPEED = 4.5, HIT_SPARK_SIZE = 2.5, HIT_SPARK_COLOR = 'rgba(255, 255, 180, 0.9)', HIT_SPARK_GRAVITY = 0.05, HIT_SPARK_FADE_SPEED = 1.0 / HIT_SPARK_LIFETIME, UI_TEXT_MARGIN_TOP = 35, UI_1UP_BLINK_ON_MS = 600, UI_1UP_BLINK_OFF_MS = 400, UI_1UP_BLINK_CYCLE_MS = UI_1UP_BLINK_ON_MS + UI_1UP_BLINK_OFF_MS, AI_SHOOT_COOLDOWN = 140, AI_STABILIZATION_DURATION = 500, AI_POSITION_MOVE_SPEED_FACTOR = 1.2, AI_COLLISION_LOOKAHEAD = SHIP_HEIGHT * 3.5, AI_COLLISION_BUFFER = SHIP_WIDTH * 0.6, FINAL_DODGE_LOOKAHEAD = AI_COLLISION_LOOKAHEAD * 4.5, FINAL_DODGE_BUFFER_BASE = AI_COLLISION_BUFFER * 3.5, ENTRANCE_BULLET_DODGE_LOOKAHEAD = FINAL_DODGE_LOOKAHEAD * 1.1, ENTRANCE_BULLET_DODGE_BUFFER = FINAL_DODGE_BUFFER_BASE * 1.1, FINAL_AI_DODGE_MOVE_SPEED_FACTOR = 3.8, AI_SHOOT_ALIGNMENT_THRESHOLD = 0.15, AI_SHOT_CLEARANCE_BUFFER = PLAYER_BULLET_WIDTH * 1.5, MAX_PREDICTION_TIME_CS = 0.7, NORMAL_MOVE_FRACTION = 0.08, CS_AI_MOVE_FRACTION = 0.16, AI_SMOOTHING_FACTOR_MOVE = 0.05, CS_MOVE_SPEED_FACTOR = 1.8, NORMAL_WAVE_ATTACKING_DODGE_BUFFER_MULTIPLIER = 1.2, NORMAL_WAVE_ATTACKING_DODGE_SPEED_MULTIPLIER = 1.1, STABILIZE_MOVE_FRACTION = 0.05, ENTRANCE_DODGE_MOVE_FRACTION = 0.15, AI_MOVEMENT_DEADZONE = 0.8, AI_SMOOTHING_FACTOR = 0.1, AI_EDGE_BUFFER = SHIP_WIDTH * 0.5, AI_ANTI_CORNER_BUFFER = AI_EDGE_BUFFER * 2.5, BEE_DODGE_BUFFER_HORIZONTAL_FACTOR = 1.5, FINAL_SHOOT_ALIGNMENT_THRESHOLD = 2.0, GRID_SHOOT_ALIGNMENT_FACTOR = 1.5, ENTRANCE_SHOOT_ALIGNMENT_FACTOR = 1.2, ENTRANCE_AI_DODGE_MOVE_SPEED_FACTOR = 4.0, AI_WIGGLE_AMPLITUDE = SHIP_WIDTH * 0.15, AI_WIGGLE_PERIOD = 3000, AI_EDGE_SHOOT_BUFFER_FACTOR = 2.0, AI_EDGE_SHOOT_TARGET_THRESHOLD_FACTOR = 0.75, ENTRANCE_SHOOT_BULLET_CHECK_LOOKAHEAD = SHIP_HEIGHT * 1.5, ENTRANCE_SHOOT_BULLET_CHECK_BUFFER = SHIP_WIDTH * 0.8, MAX_PREDICTION_TIME = 0.8, LOCAL_CS_POSITION_MIN_X = 0, LOCAL_CS_POSITION_MAX_X = 0, CS_SHOOTING_MOVE_FRACTION = 0.25, CS_SHOOTING_MOVE_SPEED_FACTOR = 2.0, CS_PREDICTION_FACTOR = 1.0, AI_CAPTURE_WAIT_DURATION_MS = 2000, INTRO_DURATION_PER_STEP = 4000, TWO_PLAYER_STAGE_INTRO_DURATION = 3000, READY_MESSAGE_DURATION = 3000, CS_HITS_MESSAGE_DURATION = 1000, CS_PERFECT_MESSAGE_DURATION = 1000, CS_BONUS_MESSAGE_DURATION = 5000, CS_CLEAR_DELAY = 8000, CS_CLEAR_HITS_DELAY = 1000, CS_CLEAR_SCORE_DELAY = 2000, EXTRA_LIFE_MESSAGE_DURATION = 3000, RECURRING_EXTRA_LIFE_INTERVAL = 70000, POST_MESSAGE_RESET_DELAY = 1000, EXTRA_LIFE_THRESHOLD_1 = 20000, EXTRA_LIFE_THRESHOLD_2 = 70000;
...
async function loadSound(soundName, filePath, loop = false, initialVolume = 1.0) {
...
function initializeDOMElements() {
    ...
    if (audioContext) {
        const soundFiles = [
            ...
            { name: explosionSound,      path: "Geluiden/kill.mp3",            volume: 0.4 },
            { name: gameOverSound,       path: "Geluiden/gameover.mp3",        volume: 0.4 },
            { name: lostLifeSound,       path: "Geluiden/lost-live.mp3",       volume: 0.6 },
            { name: entranceSound,       path: "Geluiden/Entree.mp3",          volume: 0.4 },
            { name: bossGalagaDiveSound, path: "Geluiden/Enemy2.mp3",          volume: 0.2 },
            { name: levelUpSound,        path: "Geluiden/LevelUp.mp3",         volume: 0.2 },
            { name: enemyShootSound,     path: "Geluiden/Fire-enemy.mp3",      volume: 0.4 },
            { name: butterflyDiveSound,  path: "Geluiden/flying.mp3",          volume: 0.2 },
            { name: startSound,          path: "Geluiden/Start.mp3",           volume: 0.4 },
            { name: coinSound,           path: "Geluiden/coin.mp3",            volume: 0.4 },
            { name: beeHitSound,         path: "Geluiden/Bees-hit.mp3",        volume: 0.3 },
            { name: butterflyHitSound,   path: "Geluiden/Butterfly-hit.mp3",   volume: 0.3 },
            { name: bossHit1Sound,       path: "Geluiden/Boss-hit1.mp3",       volume: 0.6 },
            { name: bossHit2Sound,       path: "Geluiden/Boss-hit2.mp3",       volume: 0.4 },
            { name: gridBackgroundSound, path: "Geluiden/Achtergrond-grid.mp3",volume: 0.1, loop: true },
            { name: extraLifeSound,      path: "Geluiden/Extra-Leven.mp3",     volume: 0.5 },
            { name: csPerfectSound,      path: "Geluiden/CS-Stage-Perfect-.mp3",volume: 0.6 },
            { name: csClearSound,        path: "Geluiden/CS-Clear.mp3",        volume: 0.6 },
            { name: waveUpSound,         path: "Geluiden/Waveup.mp3",          volume: 0.8 },
            { name: menuMusicSound,      path: "Geluiden/Menu-music.mp3",      volume: 0.2, loop: true },
            { name: readySound,          path: "Geluiden/ready.mp3",           volume: 0.1 },
...
function playSound(soundNameKey) {
    ...
    try {
        ...
        source.connect(asset.gainNode);
        source.loop = asset.loop;

        source.start(0);
        asset.activeSources.push(source);
        ...
        console.error(`Error playing sound ${soundNameKey}:`, e);
    }
}

/** Safely attempts to stop a sound and reset its position. */
function stopSound(soundNameKey) {
    if (!audioContext || !soundAssets[soundNameKey]) {
        return;
    }
    try {
        const asset = soundAssets[soundNameKey];
        asset.activeSources.forEach(source => {
            try {
                source.stop(0);
            } catch (e) {
            }
        ...
        console.error(`Error stopping sound ${soundNameKey}:`, e);
    }
}
            ...
            if (!isPaused) {
                if (!isManualControl) {
                    ...
                    switch (e.code) {
                        ...
                        case "KeyJ": case "Numpad4": if(isTwoPlayerMode) keyboardP2LeftDown = true; break;
                        case "KeyL": case "Numpad6": if(isTwoPlayerMode) keyboardP2RightDown = true; break;
                        case "KeyI": case "Numpad0": if(isTwoPlayerMode) keyboardP2ShootDown = true; break;
                        case "Escape": case "Enter": if(typeof stopGameAndShowMenu === 'function') stopGameAndShowMenu(); break;
                    }
                    if (!keyboardP2LeftDown && isTwoPlayerMode && e.key.toLowerCase() === "j") keyboardP2LeftDown = true;
                    if (!keyboardP2RightDown && isTwoPlayerMode && e.key.toLowerCase() === "l") keyboardP2RightDown = true;
                    if (!keyboardP2ShootDown && isTwoPlayerMode && e.key.toLowerCase() === "i") keyboardP2ShootDown = true;
                }
            }
        } else {
                ...
                switch (e.key) {
                    ...
                    case "Enter": case " ":
                        if (isGameModeSelectMode) {
                            ...
                            isGameModeSelectMode = false; isFiringModeSelectMode = true; selectedButtonIndex = 0;
                    ...
                    case "Escape":
                        if (isGameModeSelectMode) { isGameModeSelectMode = false; isPlayerSelectMode = true; selectedButtonIndex = 1; }
                        else if (isFiringModeSelectMode) { isFiringModeSelectMode = false; if(isTwoPlayerMode) {isGameModeSelectMode = true; selectedButtonIndex = (selectedGameMode === 'coop' ? 1 : 0);} else {isPlayerSelectMode = true; selectedButtonIndex = 0;} }
                        else if (isPlayerSelectMode) { isPlayerSelectMode = false; selectedButtonIndex = 0; }
